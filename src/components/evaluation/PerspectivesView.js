				...
				<hr />
				{
					!isLoading ?
						perspectives && perspectives.length > 0 ?
							...
							:
							<NoContentToShow icon='face' messageTitle={'Sin perspectivas...'} messageDes={localStorage.getItem('user_role') === 'student' ? 'No hay perspectivas que mostrar, aquí se mostrarán las evaluaciones de tus profesores' : 'No hay perspectivas que mostrar, aquí se mostrarán las que agregues a un estudiante.'} />
						:
