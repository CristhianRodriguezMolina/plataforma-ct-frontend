    ...
    return (
        <div className="navbar">
            <div className="ml-auto">
                ...
                <Link className="btn btn-primary ml-auto mr-2" to="/user/teachers">Teacher manage</Link>
                <Link className="btn btn-primary ml-auto mr-2" to="/user/students">Students manage</Link>
